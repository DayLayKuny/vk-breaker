...
function Support({ openAuth, onOpenAuth }) {
  return (
    <>
      <div className="all-support">
        ...
        <div className="downstream-support">
          ...
          <div className="supform-info">
            ...
            <p>
              Наша специалисты всегда на связи и рады ответить на Ваши вопросы.
            </p>
            <h4>Техническая поддержка:</h4>
            <p>support@vzlom-vk.ru</p>
            <p>
              По общим вопросам, включая партнерские возможности, обращайтесь по
              электронной почте:
            </p>
            <h4>Отдел расчетов:</h4>
            <p>billing@vzlom-vk.ru</p>
            <p>
              Регистрируя профиль на панели мониторинга, вы автоматически
              принимаете все необходимые условия
            </p>
            <a href="/policy-privacy">условия и положения.</a>
          </div>
        </div>
      </div>
    </>
